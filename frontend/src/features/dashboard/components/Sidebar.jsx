      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 h-[68px] shrink-0 border-b border-edge/[0.06] dark:border-edge/[0.08]">
          ...
          <div className="leading-tight">
            ...
            <p className="text-[11px] text-content-md">Fraud Analysis &amp; Risk Scoring</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="px-4 pb-3">
          <div className="rounded-2xl border border-edge/[0.08] dark:border-edge/[0.10] bg-surface-2 p-3.5">
            <p className="text-[11px] font-semibold text-content-hi">System Status</p>
            <div className="mt-2 flex items-center gap-2">
              ...
              />
              <span className={`text-xs ${online ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-500'}`}>
